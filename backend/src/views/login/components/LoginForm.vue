    ...
    <Card class="overflow-hidden">
      <CardContent class="grid p-0 md:grid-cols-2">
          ...
          <form @submit.prevent="onSubmit">
            <div class="flex flex-col gap-6">
              ...
              <div class="grid gap-2">
                ...
                <Input v-model="params.username" id="username" type="text" placeholder="admin" required />
              </div>
              <div class="grid gap-2">
                ...
                <Input v-model="params.password" id="password" type="password" required />
              </div>
        ...
        <div class="flex items-center justify-center">
          <img src="@/assets//svg/login-logo.svg" alt="Image"
